package com.diego.matesanz.idealista.ui.screens.productDetail.mocks
...
val productDetail = ProductDetail(
    adid = 1,
    price = 1195000.0,
    priceInfo = ProductDetail.PriceInfo(
        amount = 1195000.0,
        currencySuffix = "€",
    ),
    operation = "sale",
    ...
    ubication = ProductDetail.Ubication(
        latitude = 40.4362687,
        longitude = -3.6833686,
    ),
    country = "es",
    moreCharacteristics = ProductDetail.MoreCharacteristics(
    ...
    energyCertification = ProductDetail.EnergyCertification(
        title = "Certificado energético",
        energyConsumption = ProductDetail.EnergyCertification.EnergyConsumption(
            type = "e",
        ),
        emissions = ProductDetail.EnergyCertification.Emissions(
            type = "e",
        ),
    ),
)
